...
public class JwtTokenProvider {
    ...
    public Long getUserIdFromJWT(String accountId) {
        return userFacade.getUserId(accountId);
    }
    ...
    public boolean validateToken(String token) {
        try {
            Jwts.parser().setSigningKey(jwtProperty.getSecretKey()).build().parseClaimsJws(token);
            return true;
        } catch (Exception e) {
            return false;
        }
